...
$country = 'Россия';
$email = 'zverkovmi@gmail.com';
$phone = '+7(968)193-64-01';
$skills = [
    [
        'name' => 'Фотошоп',
        'percent' => 30,
...
$experiences = [
    [
        ...
        'company' => null,
        'data_start' => date('M Y', mktime(0, 0, 0, 1, 1, 2015)),
        'data_end' => null,
    ...
    [
        ...
        'data_start' => date('M Y', mktime(0, 0, 0, 3, 1, 2012)),
        'data_end' => date('M Y', mktime(0, 0, 0, 12, 1, 2014)),
    ...
    [
        ...
        'data_start' => date('M Y', mktime(0, 0, 0, 6, 1, 2010)),
        'data_end' => date('M Y', mktime(0, 0, 0, 3, 1, 2012)),
            ...
            <div class="w3-third">
                <div class="w3-white w3-text-grey w3-card-4">
                    ...
                    <div class="w3-container">
                        ...
                        <?php foreach ($skills as $scill): ?>
                            <p>
                                <?php echo $scill['name'] ?>
                            </p>
                            <div class="w3-light-grey w3-round-xlarge w3-small">
                                <div class="w3-container w3-center w3-round-xlarge w3-teal"
                                    style="width:<?php echo $scill['percent'] ?>%">
                                    <?php echo $scill['percent'] ?>
                                </div>
                            </div>
                        <?php endforeach ?>
                        <br>
                    ...
                    <?php foreach ($experiences as $experience): ?>
                        <div class="w3-container">
                            ...
                            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right">
                                ...
                                <?php echo $experience['data_start'] ?>
                                 -
                                <?php if ($experience['data_end']):
                                    echo ($experience['data_end']) ?>
